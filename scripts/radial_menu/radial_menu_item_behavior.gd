...
func draw_segment(center: Vector2, start_angle: float, end_angle: float) -> void:
	...
	var _angle_padding := lerpf(
		0, lerpf(angle_padding, hower_angle_padding, _hover_state), _enter_state
	)
	...
	var _radius_padding := lerpf(
		0, lerpf(radius_padding, hower_radius_padding, _hover_state), _enter_state
	)
	m.draw_segment(
		center,
		_radius_a,
...
func edit_item(center: Vector2, start_angle: float, end_angle: float) -> void:
	...
	var pos := RadialMenuUtils.segment_releative_point(
		center,
		_radius_a,
		_radius_b,
		_radius_padding,
